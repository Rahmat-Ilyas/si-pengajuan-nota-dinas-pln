						...
						<table class="table table-striped text-center" id="table-1">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="#" class="btn btn-success btn-sm" data-confirm="Setujui Nota Dinas?|Lanjutkan menyetujui nota dinas ini?" data-confirm-yes="document.location.href='{{ url('keuangan/notadinas/setujui/'.$dta->id) }}';">Setujui</a>
										<a href="#" class="btn btn-danger btn-sm" data-confirm="Tolak Nota Dinas?|Lanjutkan menolak nota dinas ini?" data-confirm-yes="document.location.href='{{ url('keuangan/notadinas/tolak/'.$dta->id) }}';">Tolak</a>
									</td>
								</tr>
								@endforeach
							</tbody>
