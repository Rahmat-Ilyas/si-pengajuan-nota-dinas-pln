    ...
    <div class="main-sidebar sidebar-style-2">
      <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
          <li class="home">
            <a href="{{ url('admin') }}" class="nav-link"><i class="fas fa-home"></i><span>Home</span></a>
          </li>
          <li class="pengajuanmasuk">
            <a href="{{ url('admin/suratmasuk') }}" class="nav-link"><i class="far fa-file-alt"></i> <span>Surat Pengajuan (Masuk)</span></a>
          </li>
          <li class="pengajuankeluar">
            <a href="{{ url('admin/suratkeluar') }}" class="nav-link"><i class="fas fa-file-alt"></i> <span>Surat Pengajuan (Keluar)</span></a>
          </li>
          <li class="dropdown masterdata">
            <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Master Data</span></a>
            <ul class="dropdown-menu">
              <li class="datapegawai"><a class="nav-link" href="{{ url('admin/datapegawai') }}">Data Pegawai</a></li>
              <li class="datayakes"><a class="nav-link" href="{{ url('admin/datayakes') }}">Data Yakes</a></li>
            </ul>
          </li>
        </ul>
      </aside>
